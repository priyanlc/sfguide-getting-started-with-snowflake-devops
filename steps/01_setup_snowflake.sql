...
CREATE DATABASE IF NOT EXISTS PL_RE_POC;


-- API integration is needed for GitHub integration
CREATE OR REPLACE API INTEGRATION git_api_integration
  API_PROVIDER = git_https_api
  API_ALLOWED_PREFIXES = ('https://github.com/priyanlc') -- INSERT YOUR GITHUB USERNAME HERE
  ENABLED = TRUE;
...
CREATE OR REPLACE GIT REPOSITORY quickstart_common.public.quickstart_repo
  ...
  ORIGIN = 'sfguide-getting-started-with-snowflake-devops'; -- INSERT URL OF FORKED REPO HERE


CREATE OR REPLACE DATABASE PL_RE_POC_PROD;
